...
import type { AuditWorkspaceData } from "../models/audit.models";
...
function data(): AuditWorkspaceData { return { requirements: [{ id: "r", requirementId: "req", toStatus: "Draft", action: "Crear", performedBy: "Ana", comments: "", occurredAt: "2026-07-01" }], products: [{ id: "p", activityId: "prod", requirementId: "req", toStatus: "Todo", action: "Crear", performedBy: "Luis", comments: "", occurredAt: "2026-07-02" }], approvals: [], warnings: [] }; }
