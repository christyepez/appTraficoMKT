...
export type AgendaWorkspaceData = { activities: Activity[]; requirements: Requirement[]; technicians: Technician[]; items: AgendaItem[]; workdayStartTime: string; workdayEndTime: string };
